...
import {get, cache, cacheArray} from '../lib/repo-basic-cache'
...
export default function(Comp, type = 'index' ) {
    function withIndex({repoBasic, router, ...rest}) {
    ...
    withIndex.getInitialProps = async (context) =>{
